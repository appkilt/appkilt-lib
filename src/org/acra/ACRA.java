 ...
 * been set by using {@link ReportSettings} above the declaration of your
...
public class ACRA {
    ...
    private static ReportSettings mReportsCrashes;
     ...
     */
    public static void init(Application app, ReportSettings settings) {
        mAppStartDate = new Time();
        mAppStartDate.setToNow();
        mApplication = app;
        mReportsCrashes = settings;
     ...
     * with {@link ReportSettings#sharedPreferencesName()}.
     * 
     ...
     * @return ACRA {@link ReportSettings} configuration instance.
     */
    public static ReportSettings getConfig() {
     ...
     * {@link ReportSettings#reportFields()}.
     */
